...
void gSLICr::engines::core_engine::Draw_Segmentation_Edges(UChar4Image* out_img)
{
    slic_seg_engine->Draw_Segmentation_Edges(out_img);
}

void gSLICr::engines::core_engine::Write_Seg_Res_To_PGM(const char* fileName, unsigned short *lable_array)
{
